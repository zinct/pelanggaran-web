                                ...
                                <div class="card-body">
                                    <form action="<?php echo base_url()?>login/reset_password" method="POST">
                                        ...
                                        <div class="text-center mb-4">
                                          <p>Silhakan Masukan kombinasi NIP/NIM dengan Email Anda</p>
                                      </div>
                                      <div class="form-group">
                                        <label class="small mb-1" for="inputEmailAddress">NIP/NIM</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputPassword" type="email" name="email" />
                                    </div>
