                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo base_url()?>login/reset_password_proses" method="POST">
                                        ...
                                        <div class="text-center mb-4">
                                          <p>Silahkan Masukan Kata Sandi Baru</p>
                                      </div>
                                      <div class="form-group">
                                        <label class="small mb-1" for="inputEmailAddress">NIM/NIP</label>
                                        <input class="form-control py-4" id="password" type="text" name="pengguna" value="<?php echo $pengguna ;?>" readonly=""/>
                                        <input class="form-control py-4" id="password" type="hidden" name="jenis" value="<?php echo $jenis ;?>" />
                                        <input class="form-control py-4" id="password" type="hidden" name="email" value="<?php echo $email ;?>" />
                                    </div>
                                      <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="password2" type="password" name="password2" />
                                    </div>
                                    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                        <a class="small" href="<?php echo base_url()."login"; ?>">Kembali</a>
