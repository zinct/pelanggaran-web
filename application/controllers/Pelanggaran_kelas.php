...
class Pelanggaran_kelas extends CI_Controller {
	...
	function laporan() {
    $pelanggaran_data = $this->Pelanggaran_data_model->get_pelanggaran_kelas($this->Pelanggaran_data_model->get_TahunAktif()->id_tahun, $this->session->userdata('id_kelas'));
    ...
    ';
		...
		foreach ($pelanggaran_data as $row) {
			...
			<td nowrap>
				...
				<span><em>Catatan: '. $row->catatan.'</em></span>
			</td>
