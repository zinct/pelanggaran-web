...
class Laporan_pelanggaran_siswa extends CI_Controller {
  ...
  public function index() {
    $data['halaman'] = "Laporan Pelanggaran Siswa";
    $data['pelanggaran_data'] = $this->Pelanggaran_data_model->get_laporan_pelanggaran_siswa($this->Pelanggaran_data_model->get_TahunAktif()->id_tahun);
    $this->template->load('template/admin', 'laporan_pelanggaran_siswa/index', $data);
  }

  function laporan() {
    $pelanggaran_data = $this->Pelanggaran_data_model->get_laporan_pelanggaran_siswa($this->Pelanggaran_data_model->get_TahunAktif()->id_tahun);
